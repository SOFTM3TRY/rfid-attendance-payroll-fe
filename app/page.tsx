...
export default function Login() {
  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row-reverse">
      <ModeToggle />
      <div className="flex flex-col justify-center items-center flex-1 p-8 bg-gray-50 shadow-lg dark:bg-gray-900">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-6">
          ...
          <div className="relative">
            <label htmlFor="password" className="block mb-2 font-normal text-sm">
              Password
            </label>
            <input
      ...
      <div className="hidden md:flex relative flex-1 overflow-hidden bg-cyan-800 dark:bg-cyan-900 items-center justify-center p-8">
...
const EyeOffIcon = () => (
  <svg
    ...
    strokeWidth={2}
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.083.183-2.127.52-3.105M3 3l18 18" />
  </svg>
);
