      ...
      <SidebarProvider style={{ height: "100vh", width: "100%" }}>
        ...
        <main className="w-full h-auto">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center justify-center mb-20 p-0 mt-10">
              <div className="w-1/2 rounded-md">
                <div className="sticky top-12 shadow-lg dark:border-b-4 dark:border-black z-2 w-full py-5 flex justify-start rounded-md items-center px-5 gap-5 bg-zinc-100 dark:bg-zinc-900 mb-2">
