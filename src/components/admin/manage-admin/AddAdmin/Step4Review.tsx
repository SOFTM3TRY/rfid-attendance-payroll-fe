    ...
    async function fetchNames() {
      ...
      if (formData.province) {
        if (
          ...
          if (isMounted) setProvinceName("Metro Manila");
        } else {
      ...
      <div className="flex flex-col gap-2 bg-zinc-100 dark:bg-zinc-900/50 rounded-md p-5 mt-5 mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm font-light">{regionName || formData.region || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">Province :</span>
            <span className="text-sm font-light">{provinceName || formData.province || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">City :</span>
            <span className="text-sm font-light">{cityName || formData.city || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">Barangay :</span>
            <span className="text-sm font-light">{barangayName || formData.barangay || "-"}</span>
          </div>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">First Name :</span>
            <span className="text-sm font-light">{formData.emergency_fname || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">Middle Name :</span>
            <span className="text-sm font-light">{formData.emergency_mname || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">Last Name :</span>
            <span className="text-sm font-light">{formData.emergency_lname || "-"}</span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-sm font-semibold">Emergency Contact :</span>
            <span className="text-sm font-light">{formData.emergency_contact || "-"}</span>
          </div> */}
        </div>
      </div>
    </div>
